---
title: "source-to-notes context (historical session logs snippets)"
date: "2026-03-18"
source: "session-logs"
...
7923-To github.com:RadonX/openclaw-skills.git
7924-   bc3f7cf..cc931df  main -> main
7925-cc931df skills: add per-skill session-log snippet artifacts
--
...
7946-removing 'artifacts/bindings-simplifier\ncloudflare-browser-rendering\ncommit-message\ngithub-issue-methodology\nhandoff\nintent-writer\nkb-steward\nkb-steward-companion\nkb-steward-tools\nskill-distiller\nskill-distiller-gemini\nsource-to-notes/context/2026-03-18_session-snippets.md'
7947-[main 395ce76] fix: remove accidental newline-path artifact file
7948- 1 file changed, 22 deletions(-)
--
8017-没有泄露敏感信息吧？
8018-用source to notes skill
8019-[toolResult] ---
8020:name: source-to-notes
8021-description: Turn an OpenClaw conversation (session history) into usable dialogue materials and/or lightweight notes. The agent decides whether to run Step One extraction based on context; extracted materials default to /tmp/. Goal is optional: omitted goal triggers default behavior.
8022-metadata:
8023-  author: RadonX
--
8026-    emoji: "🗂️"
8027----
8028-
8029:# source-to-notes
8030-
8031-Interface (single entry):
8032-
8033:- `/source-to-notes [goal] [--session <sessionKey>] [--message-id-start <id>] [--message-id-end <id>] [--out <path>] [--apply]`
8034-
8035-Defaults:
8036-- If `--session` omitted: use current session
--
...
8121-
8122-### 结论（目前看没有明显泄露 secret）
8123-我搜了这些高风险模式（命中会直接红灯）：
